<template>
  <div class="richEditor-moudle">
    <QiCard width="100%" height="100%">
...
import { convertFileToBase64, convertFileToURL } from '@/utils/convertFile';
  ...
  async customUpload(file: File, insertFn: InsertFnTypeImg) {
    ...
    try {
      ...
      convertFileToBase64(file).then(res => {
        insertFn('data:image/png;base64,' + res);
      });
    } catch (error) {
      console.log(error);
    }
